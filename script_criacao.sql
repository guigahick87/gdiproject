...
CREATE SEQUENCE cod_atracao START WITH 1 INCREMENT BY 1 NOMAXVALUE NOCYCLE ORDER;
...
CREATE SEQUENCE cod_programacao START WITH 1 INCREMENT BY 1 NOMAXVALUE NOCYCLE ORDER;
...
CREATE SEQUENCE cod_estudio START WITH 1 INCREMENT BY 1 NOMAXVALUE NOCYCLE ORDER;
...
ALTER TABLE EXIBICAO_PLANTAO ADD CONSTRAINT exibicao_plantao_pk PRIMARY KEY(data_hora, cod_programacao, cod_atracao, cod_estudio);
ALTER TABLE EXIBICAO_PLANTAO ADD CONSTRAINT e_plantao_data_hora_plantao_fk FOREIGN KEY(data_hora) REFERENCES PLANTAO(data_hora) ON DELETE SET NULL;
